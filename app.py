...
# Resolve relative to this script's own folder, not whatever directory the
# terminal happens to be in when you launch streamlit — otherwise SQLite
# silently creates a new empty retail.db in the wrong place instead of
# opening the one with your data (this is what caused "no such table: orders").
